 ...
 * @method static validator\rule\RuleBuilder required()                                                                                                                                            Requires a field
 * @method static validator\rule\RuleBuilder requiredIf($isRequired)                                                                                                                               Requires a field if $isRequired is true
 * @method static validator\rule\RuleBuilder optional()                                                                                          Field does not require a value (will return null)
 * @method static validator\rule\RuleBuilder optionalIf($isOptional)                                                                                                                               Field does not require a value if $isOptional is true
 */
class Validator {
